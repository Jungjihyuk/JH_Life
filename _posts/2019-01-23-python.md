...
txt file read error => [blog](https://blog.naver.com/PostView.nhn?blogId=yejoon3117&logNo=221058408177&beginTime=0&jumpingVid=&from=search&redirect=Log&widgetTypeCall=true)
python input vs raw_input => [tistory](https://aceatom.tistory.com/13)
atom editor 단축키 모음 => [tistory](https://ondesk.tistory.com/178)
